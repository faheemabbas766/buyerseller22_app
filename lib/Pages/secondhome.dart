...
class _HomePageState extends State<HomePage> {
  ...
  void _getData() {
    ...
    height = 320px
     */
    // _bannerData.add(BannerSliderModel(id: 1, image: GLOBAL_URL+'/apps/food_delivery/home_banner/1.jpg'));
    // _bannerData.add(BannerSliderModel(id: 2, image: GLOBAL_URL+'/apps/food_delivery/home_banner/2.jpg'));
    // _bannerData.add(BannerSliderModel(id: 3, image: GLOBAL_URL+'/apps/food_delivery/home_banner/3.jpg'));
    // _bannerData.add(BannerSliderModel(id: 4, image: GLOBAL_URL+'/apps/food_delivery/home_banner/4.jpg'));
    ...
    height = 110px
     */
    // _categoryData.add(CategoryModel(id: 1, name: 'Nearby', image: GLOBAL_URL+'/apps/food_delivery/category/nearby.png'));
    // _categoryData.add(CategoryModel(id: 2, name: 'Western Food', image: GLOBAL_URL+'/apps/food_delivery/category/western.png'));
    // _categoryData.add(CategoryModel(id: 3, name: 'Eastern Food', image: GLOBAL_URL+'/apps/food_delivery/category/eastern.png'));
    // _categoryData.add(CategoryModel(id: 4, name: 'Healthy Food', image: GLOBAL_URL+'/apps/food_delivery/category/health.png'));
    // _categoryData.add(CategoryModel(id: 5, name: 'Coffee', image: GLOBAL_URL+'/apps/food_delivery/category/coffee.png'));
    // _categoryData.add(CategoryModel(id: 6, name: 'New Comers', image: GLOBAL_URL+'/apps/food_delivery/category/new.png'));
    // _categoryData.add(CategoryModel(id: 7, name: 'Best Sellers', image: GLOBAL_URL+'/apps/food_delivery/category/best.png'));
    // _categoryData.add(CategoryModel(id: 8, name: 'All Foods', image: GLOBAL_URL+'/apps/food_delivery/category/all.png'));
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text('DELIVER TO', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w400, color: Colors.black)),
            GestureDetector(
              onTap: () {
              ...
              child: Row(
                children: [
                  Flexible(
                    child: Text(_address, style: TextStyle(fontSize: 15, color: Colors.black), maxLines: 1, overflow: TextOverflow.ellipsis),
                  ),
              ...
              child: TextButton(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 8),
                    Text('What are you craving ?', style: TextStyle(color: Colors.grey[500], fontWeight: FontWeight.normal))
                  ],
                ),
              ),
            ),
